...
- **Agente Especialista (RAG):** Simulação de um motor RAG (*Retrieval-Augmented Generation*) que cruza o alerta gerado com a BOM (*Bill of Materials*) do balcão e manuais técnicos, gerando diagnósticos humanizados.
...
- **Scikit-learn** — Modelo preditivo não supervisionado (*Isolation Forest*)
...
Utilize o menu de seleção (*dropdown*) no topo do painel para alternar entre eles:
